...
.. warning::
   ...
   Changing these Phoenix parameters may affect FDA-cleared behavior.
...
.. note::
   ...
   This option is only available on XA30 SP03 and later.

.. tip::

   Use the SBRef series for registration when available.
