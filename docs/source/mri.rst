...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**New user under existing lab:** Your lab can create an account for you. See :ref:`add-user` below. This also applies to users who need to access SIStat, but do not scan (e.g., schedulers and fund managers).
